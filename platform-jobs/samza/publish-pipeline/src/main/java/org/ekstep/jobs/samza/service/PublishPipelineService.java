...
System.out.println("BODY IS: "+node.getMetadata().get("body"));
System.out.println("NODE.GETMETADATA() IS: "+node.getMetadata());
System.out.println("BODY NAME AND NODE IDENTIFIER IS: "+node.getIdentifier()+"\n"+PublishPipelineParams.body.name());
		}
	}
